...
const variants = {
  ...
  // lifts off the page.
  primary:
    'bg-saffron-500 text-temple-900 hover:bg-saffron-400 shadow-soft hover:shadow-saffron dark:text-ink-900 dark:hover:bg-saffron-400 dark:hover:shadow-saffron dark:glow-gold-soft',
