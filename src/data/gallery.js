/**
 * Gallery items. Real temple photos sit in the first two slots —
 * `little-1.jpg` (dramatic, dark) and `little-2.jpg` (soft, daylight).
 * Remaining items are placeholders that map onto the design system
 * until more photography is provided.
 */
export const galleryItems = [
  ...
  { id: 'g6', kind: 'placeholder', label: 'Prasadam service', aspect: '1/1' },
  { id: 'g7', kind: 'placeholder', label: 'Be SMART course batch', aspect: '4/5' },
  { id: 'g8', kind: 'placeholder', label: 'Sandhya Arati', aspect: '3/4' },
];
